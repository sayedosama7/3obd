...
const Contact = () => {
  return (
    <div>
      <Container fluid className='contact py-5' id='contact'>
        <h2 className='text-center fw-bold text-blue mb-5 wow bounceInUp' data-wow-delay=".1s" data-wow-duration="1.5s">contact</h2>
        <Row>
          <Col md="12">
            ...
            <Form className='w-50 m-auto'>
              ...
              <button type='submit' className='btn btn-info send m-auto d-block w-100 p-3 wow bounceInUp fw-bold' data-wow-delay="1s" data-wow-duration="1.5s">Send</button>
            </Form>
          </Col>
